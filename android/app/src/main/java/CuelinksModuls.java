package com.CuelinksSDKIntegration;
...
public class CuelinksModuls extends ReactContextBaseJavaModule {

    private final ReactApplicationContext reactContext;

    public CuelinksModuls(ReactApplicationContext reactContext) {
        super(reactContext);
